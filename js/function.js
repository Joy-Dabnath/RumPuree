(function ($) {
	...
	if ($('.testimonial-slider-stone').length) {
		const testimonial_slider_stone = new Swiper('.testimonial-slider-stone .swiper', {
			...
			pagination: {
				el: '.testimonial-pagination-stone',
				clickable: true,
			},
			navigation: {
	...
	/* testimonial Slider JS */
	if ($('.testimonial-slider-pioneer').length) {
		const testimonial_slider_pioneer = new Swiper('.testimonial-slider-pioneer .swiper', {
			slidesPerView : 1,
			speed: 1000,
			spaceBetween: 30,
			loop: true,
	...
	/* What We Do Slider JS */
	var swiper = new Swiper(".what-we-do-img-item-pioneer", {
		spaceBetween: 15,
		slidesPerView: 3,
		loop: true,
		breakpoints: {
	...
	var swiper2 = new Swiper(".what-we-do-img-pioneer", {
		spaceBetween: 10,
		effect: 'fade',
		loop: true,
		speed: 1000,
